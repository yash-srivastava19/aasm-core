...
module AASM
  class Base
    ...
    def initialize(klass, name, state_machine, options={}, &block)
      ...
      # Forbid direct assignment of aasm_state column — always on in this fork.
      # Set to false explicitly only if you need to seed state in tests.
      configure :no_direct_assignment, true
